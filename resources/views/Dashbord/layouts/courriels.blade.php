    ...
    <li class="nav-item">
      ...
      <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="livreurs">Livreurs</a>
          <a class="collapse-item" href="coursiers">Coursiers</a>
          <a class="collapse-item" href="utilisateurs">Utilisateurs</a>
          <a class="collapse-item" href="colis">Colis</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                  ...
                  <span class="ml-2 d-none d-lg-inline text-white small">Angaman</span>
                </a>
        ...
        <div class="container-fluid" id="container-wrapper">
            ...
            <h1> c'est la page qui va gérer les courriels </h1>
            <!--Row-->
